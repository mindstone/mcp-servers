...
| [quickbooks](./catalogue/quickbooks.html) | QuickBooks Online MCP server for Model Context Protocol hosts. Manage invoices, bills, customers, vendors, employees, and accounts in QuickBooks Online through a standardised MCP interface. | 0.4.0 | OAuth | 21 | cloud API |
