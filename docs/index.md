...
| [microsoft-mail](./catalogue/microsoft-mail.html) | Microsoft 365 Outlook Mail MCP server — list, search, read, send, reply, forward, draft, move, and delete email via the Microsoft Graph API. | 0.1.2 | OAuth (host-orchestrated) | 12 | cloud API |
