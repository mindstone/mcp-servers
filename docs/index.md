...
| [email-imap](./catalogue/email-imap.html) | Email IMAP/SMTP MCP server for Model Context Protocol hosts. Read, search, send, and manage emails through IMAP and SMTP — supports iCloud Mail, Gmail, Yahoo Mail, Outlook / Microsoft 365, and custom IMAP providers. | 0.3.1 | API key | 17 | local protocol |
