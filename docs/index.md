...
| [replit-ssh](./catalogue/replit-ssh.html) | Replit SSH MCP server — read, write, list, and check files on Replit projects over SSH/SFTP, plus one-shot generation of the local SSH key and &#96;~/.ssh/config&#96; block. | 0.1.1 | None | 5 | local protocol |
