...
| [workday](./catalogue/workday.html) | Workday HCM MCP server for Model Context Protocol hosts. Query workers, profiles, direct reports, organizations, locations, jobs, time off, and job requisitions in Workday through a standardised MCP interface using OAuth 2.0 authentication. | 0.3.0 | OAuth | 9 | cloud API |
| [xero](./catalogue/xero.html) | This is a Model Context Protocol &#40;MCP&#41; server implementation for Xero. It provides a bridge between the MCP protocol and Xero's API, allowing for standardized access to Xero's accounting and business features. | 0.1.0 | OAuth | 70 | cloud API |
