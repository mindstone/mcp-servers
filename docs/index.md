...
| [replit-ssh](./catalogue/replit-ssh.html) | Replit SSH MCP server — read, write, list, and check files on Replit projects over SSH/SFTP, plus generate the local SSH key and config. | 0.1.0 | None | 5 | local protocol |
