...
| [microsoft-mail](./catalogue/microsoft-mail.html) | Microsoft 365 Outlook Mail MCP server — list, search, read, send, reply, forward, draft, move, and delete email via the Microsoft Graph API. | 0.1.2 | OAuth (host-orchestrated) | 13 | cloud API |
...
| [microsoft-teams](./catalogue/microsoft-teams.html) | Microsoft 365 Teams MCP server — list and read Teams chats, send chat messages, list teams and channels, and read presence via the Microsoft Graph API. | 0.1.2 | OAuth (host-orchestrated) | 8 | cloud API |
...
| [slack](./catalogue/slack.html) | Slack workspace MCP server — channels, messages, threads, reactions, users, files, bookmarks, and scheduled messages via the Slack Web API. | 0.1.6 | OAuth (host-orchestrated) | 25 | cloud API |
