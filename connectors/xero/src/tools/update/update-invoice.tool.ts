 ...
 This link should be displayed to the user.",
  {
    ...
    currencyCode: z.nativeEnum(CurrencyCode).optional().describe("Optional invoice currency, such as USD. Only use a currency enabled in the connected Xero organisation."),
  },
  async (
    {
      invoiceId,
