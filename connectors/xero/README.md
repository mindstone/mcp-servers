...
This package is Mindstone's maintained build of Xero's community Xero MCP server, announced on the [Xero Developer Blog](https://devblog.xero.com/xero-introduces-new-model-context-protocol-server-for-smarter-accounting-data-integration) and developed upstream at [XeroAPI/xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server). It adds improvements and hardening by Mindstone on top of the upstream project.
...
- `email-invoice`: Email a copy of an AUTHORISED invoice to its related contact
