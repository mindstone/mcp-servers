...
/**
 * Creates a fresh MCP test client connected to the PandaDoc connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with PandaDoc-specific
