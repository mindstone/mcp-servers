...
- Land the followup fixes: @revoked fail-closed, IdentityFile accumulation, control-char stripping, and delete annotations.
...
- Replit SSH connector: canonical result envelopes, untrusted-content fencing, env-gated destructive ops; expanded filesystem actions.
