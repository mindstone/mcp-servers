...
- **Version:** [0.2.1](./CHANGELOG.md) · [npm](https://www.npmjs.com/package/@mindstone/mcp-server-microsoft-sharepoint)
...
<details>
<summary>Manual config for Claude Desktop / Claude Code / Goose / Continue.dev (Microsoft 365 SharePoint)</summary>
...
| `list_list_columns`, `create_site_list` | Read a list's column schema; create new lists with columns. |
