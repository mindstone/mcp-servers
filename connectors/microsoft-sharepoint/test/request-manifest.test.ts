...
const MANIFEST: ManifestRow[] = [
  ...
  { tool: 'create_site_page', method: 'POST', pathname: '/v1.0/sites/:siteId/pages', args: { siteId: 'site-1', title: 'Q3 Update' } },
  { tool: 'update_site_page', method: 'PATCH', pathname: '/v1.0/sites/:siteId/pages/:pageId/microsoft.graph.sitePage', args: { siteId: 'site-1', pageId: 'page-1', title: 'New title' } },
  { tool: 'publish_site_page', method: 'POST', pathname: '/v1.0/sites/:siteId/pages/:pageId/microsoft.graph.sitePage/publish', args: { siteId: 'site-1', pageId: 'page-1' } },
