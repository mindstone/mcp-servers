...
const log = createLogger('microsoft-sharepoint-mcp');
 ...
 * doesn't fail the tool call. Mirrors the bundled `microsoft-sharepoint` retry
 * semantics in the bundled Microsoft SharePoint connector.
 *
