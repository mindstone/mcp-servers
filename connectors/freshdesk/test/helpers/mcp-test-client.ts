...
/**
 * Creates a fresh MCP test client connected to the Freshdesk connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with Freshdesk-specific
