...
/**
 * Creates a fresh MCP test client connected to the Nano Banana connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with Nano Banana-specific
