...
/**
 * Creates a fresh MCP test client connected to the QuickBooks connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with QuickBooks-specific
