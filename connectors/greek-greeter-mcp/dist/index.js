...
server.registerTool("greek_greet", {
    title: "Greek Greet",
...
const GetPhrasesInputSchema = z.object({
    category: z
        ...
        .default("all")
        .describe(`Category of phrases to retrieve: greetings, politeness, basics, celebrations, food, or all`),
    limit: z
        .number()
        .int()
        .min(1)
...
server.registerTool("greek_get_phrases", {
...
Examples:
  ...
  - "Top 5 Greek politeness phrases" → { category: "politeness", limit: 5 }`,
    ...
    const categoryLabel = params.category === "all" ? "All Categories" : params.category;
