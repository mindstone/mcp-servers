...
/**
 * Creates a fresh MCP test client connected to the Outreach connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with Outreach-specific
