...
/**
 * Creates a fresh MCP test client connected to the ElevenLabs connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with ElevenLabs-specific
