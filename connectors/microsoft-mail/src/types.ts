...
export const SERVER_NAME = 'mcp-server-microsoft-mail';
export const SERVER_VERSION = pkg.version;

export const MS_PACKAGE_ID_DEFAULT = 'Microsoft365Mail';
...
function resolveRequestTimeoutMs(): number {
  ...
  console.error(
    `[microsoft-mail-mcp] MICROSOFT_REQUEST_TIMEOUT_MS=${raw} is invalid; falling back to ${DEFAULT_REQUEST_TIMEOUT_MS}ms.`,
  );
