...
/**
 * Creates a fresh MCP test client connected to the Email IMAP connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with Email-IMAP-specific
 * module reset logic: vi.resetModules() + dynamic import ensures modules
 * re-evaluate with the freshly stubbed env vars.
 */
