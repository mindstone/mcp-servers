...
/**
 * Creates a fresh MCP test client connected to the TalentLMS connector server.
 *
 * Wraps the shared test-harness createInMemoryTestClient with TalentLMS-specific
