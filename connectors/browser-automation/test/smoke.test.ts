...
// Default tool surface (20 tools): `browser_evaluate` is gated behind
...
describe('Smoke test — Browser Automation MCP server', () => {
  ...
  it('should register the default 20 tools via MCP protocol (browser_evaluate gated off)', async () => {
