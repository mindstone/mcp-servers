...
server.registerTool("apple_shortcuts_list", {
...
const RunShortcutInputSchema = z.object({
    ...
    input: z
        .string()
        .optional()
        .describe("Optional text input to pass to the shortcut as --input-path. " +
        "The shortcut receives this as its Magic Variable input."),
}).strict();
server.registerTool("apple_shortcuts_run", {
