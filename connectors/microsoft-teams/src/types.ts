...
export const SERVER_NAME = 'mcp-server-microsoft-teams';
export const SERVER_VERSION = pkg.version;

export const MS_PACKAGE_ID_DEFAULT = 'Microsoft365Teams';
...
function resolveRequestTimeoutMs(): number {
  ...
  console.error(
    `[microsoft-teams-mcp] MICROSOFT_REQUEST_TIMEOUT_MS=${raw} is invalid; falling back to ${DEFAULT_REQUEST_TIMEOUT_MS}ms.`,
  );
