...
const MANIFEST: ManifestRow[] = [
  ...
  },
  {
    ...
    args: { query: 'project', top: 1 },
  },
  {
    tool: 'get_message',
    method: 'GET',
    pathname: '/v1.0/me/chats/:chatId/messages/:messageId',
    args: { chatId: 'chat-1', messageId: 'msg-1' },
  },
  {
  ...
  },
  {
    ...
    args: { chatId: 'chat-1', messageId: 'msg-1', content: 'Thanks' },
  },
];
