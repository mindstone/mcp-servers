...
<body>
  <div class="wrapper">
    ...
    <form id="composeForm" class="card" novalidate>
      ...
      <div id="blockedBox" class="status warning hidden" role="status" aria-live="polite">
  ...
  <script>
    (function () {
      ...
      var blockedBox = document.getElementById('blockedBox');
      ...
      // ---- Blocked-send Gmail escape hatch ----
      ...
      function buildGmailComposeUrl(payload, includeBody) {
        ...
        var cc = normalizeAddressList(payload.cc).join(',');
        if (cc) params.set('cc', cc);
        var bcc = normalizeAddressList(payload.bcc).join(',');
      ...
      function handleSendRequest() {
        if (sending) return;
        // Once the user's own send preference has blocked this tool, never
      ...
      window.addEventListener('message', function (event) {
        ...
        if (data.error) {
          ...
          if (isUserDisabledSendError(errorMessage)) {
            showBlockedSend();
            return;
          }
