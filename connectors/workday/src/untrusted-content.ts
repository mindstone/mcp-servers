 ...
 * connector's own runtime source. Do NOT weaken the escaping back to a simple
...
// NOTE: divergence (1) from the header — the shared reference uses `[ \t]*`
// here; this copy deliberately widens the matcher to `\s*` so newline /
// carriage-return / form-feed close-tag variants (`</untrusted-content\n>`
// etc.) are neutralised too. This is a strict superset of the reference
// behaviour — it only escapes MORE variants, never fewer.
