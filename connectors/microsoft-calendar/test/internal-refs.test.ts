...
const pattern = /@nspr|REBEL_HOST_CONTEXT|rebel\.local|MINDSTONE_REBEL_BRIDGE_STATE|MCP_HOST_BRIDGE_STATE|REBEL_WORKSPACE_PATH|loadBridgeState|bridgeRequest|\/bundled\//;
